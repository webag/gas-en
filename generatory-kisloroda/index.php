	...
	<div class="container">
		...
		<div class="sale-block row--nopad wp">
			...
			<div class="grid-4 grid-12_m sale-percent">
				<h3 class="h2"><mark>PROMOTIONAL EVENT!</mark> Discount on generators</h3>
				<div class="sale-counter">
					...
					<form class="ajax-form column-form grey-form">
						<div class="row">
							...
							<div class="grid-6 grid-12_xs">
								...
								<input type="text" name="user_clean" placeholder="Oxygen purity" data-label="Чистота кислорода">
		...
		<div class="row">
			...
			<div class="grid-5 grid-0_m">
				<div class="lp-preims-who">
					<div class="lead-big">Vadim Robertovich</div>
...
<section class="s-lp-econom" id="s-lp-econom">
	...
	<div class="container">
		<header class="s-lp-econom__header">
			...
			<p class="h3">THE ADVANTAGES OF ALTERNATIVE SOURCES OF OXYGEN PRODUCTION</p>
		</header>
		...
		<div class="econom-block__row">
			...
			<div class="econom-block wp wp--fadeup">
				...
				<div class="econom-block__footer">
					<span class="lead">The total cost of 1 m<sup>3</sup> of gaseous oxygen:</span>
			...
			<div class="econom-block wp wp--fadeup">
				...
				<div class="econom-block__content">
					...
					<p>The average market value of one ton of liquid oxygen  is ~ 14 000 rubles</p>
				</div>
				<div class="econom-block__footer">
					<span class="lead">The total cost of 1 m<sup>3</sup> of gaseous oxygen :</span>
			...
			<div class="econom-block wp wp--fadeup">
				...
				<div class="econom-block__content">
					...
					<p>The consumption of electricity per 1 m<sup>3</sup> of oxygen  at a purity of 99.998% is 1.33 kW/h, while calculating 5 rubles per 1 kW/h</p>
				</div>
				<div class="econom-block__footer">
					<span class="lead">The total cost of 1 m<sup>3</sup> of gaseous oxygen :</span>
	...
	<div class="container">
		<div class="sale-econom wp wp--fadeup">
			...
			<div class="econom-block">
				...
				<div class="econom-block__content">
					<p class="lead-big">General Gas oxygen  generator</p>
					<p>The consumption of electricity per 1 m<sup>3</sup> of produced oxygen  at a purity of 99.99% is 0.5 kW/h, while calculating 5 rubles per 1 kW/h:</p>
				</div>
				<div class="econom-block__footer">
					<span class="lead">The total cost of 1 m<sup>3</sup> of gaseous oxygen  :</span>
			...
			<div class="sale-econom__content">
				...
				<div class="sale-econom-right">
					...
					<p class="lead-big">for the production of your own oxygen.</p>
					<ul class="checked-list">
						<li>Fast payback period (from 10 months)</li>
						<li>Complete independence from the suppliers of oxygen supplied in cylinders</li>
						<li>Rapid and easily accessible introduction</li>
					</ul>
					<a href="#" class="btn btn--green fancy" data-src="#modal-order-go" rel="nofollow">Get the proposal</a>
...
<section class="s-lp-comp" id="s-lp-comp">
	<div class="container">
		<h2 class="h1">GENERAL GAS OXYGEN GENERATOR DESIGN</h2>
	...
	<div class="container">
		...
		<div class="sale-block row--nopad">
			...
			<div class="grid-8 grid-7_l grid-12_m sale-trial sale-trial--genox">
				<h2 class="h2">Test our Oxygen Generator <mark>totally free of charge for 30 DAYS</mark></h2>
...
<section class="s-lp-table">
	...
	<div class="s-lp-table__title">
		<div class="container ">
			<h2 class="h1">GENERATOR MODEL RANGE</h2>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="sale-block row--nopad">
			...
			<div class="grid-4 grid-12_m sale-ballon sale-ballon--oxygen">
				<h3 class="sale-ballon__title">STILL BUY OXYGEN IN&nbsp;CYLINDERS?</h3>
			</div>
